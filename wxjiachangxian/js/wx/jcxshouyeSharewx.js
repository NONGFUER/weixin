...
/*微信*/
var mobile      = urlParm.mobile;                //"18900001111";  //urlParm.mobile;//鐢ㄦ埛鎵嬫満鍙�
var customerId  = urlParm.customerId;            //"8";            //urlParm.customerId;//鐢ㄦ埛id
var name		= urlParm.name;					 //濮撳悕
var idAuth		= urlParm.idAuth;				 //鏄惁瀹炲悕
var idNo		= urlParm.idNo;					 //韬唤璇佸彿
var roleType    = urlParm.roleType;              //"04";				//urlParm.roleType鐢ㄦ埛瑙掕壊
var transToken  = urlParm.transToken ? urlParm.transToken : "";//"40d1ef064f3259d6501dc15e69fb8d1c"//urlParm.transToken;			 //
var ccId        = urlParm.ccId;                  //"3";             //urlParm.ccId;鍟嗗搧缁勫悎id
var ccCode      = urlParm.ccCode;                //"00400003";      //urlParm.ccCode;鍟嗗搧缁勫悎code
var cCode       = urlParm.cCode;				 //
var cId			= urlParm.cId + "";					 //
var cityCode    = urlParm.cityCode;              //"220001"			//urlParm.cityCode	甯備唬鐮�
var	provinceCode= urlParm.provinceCode;          //"220000"			//	urlParm.provinceCode	鐪佷唬鐮�
