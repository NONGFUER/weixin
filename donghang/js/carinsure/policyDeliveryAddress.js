...
//								+ "<img alt='chooseImage' src='../../images/chooseYes.png'></div>";
//					} else {
...
//					 }
                    ...
                    str += "</div>";
//                    str += "<div class='policyAdress_modify'>";
//                    str += "<div class='policyAdress_option toEdit'><input type='hidden' id='toEdit' value='"+j+"'><div class='modifyimg'><img src='../../images/car_modifybtn.png'/></div><span>修改</span>";
//                    str += "</div>"
//                    str += "<div class='policyAdress_option toDelete'><input type='hidden' value='"+ recAddressId +"'><div class='deleteIcon'><img src='../../images/car_delete.png'/></div><span>删除</span></div>";
//					str += "</div>";
					str += "<div class='clear'></div>";
                    str += "</li>";
				}
