...
var base = {
		...
		url1 : window.location.protocol+"//"+window.location.host+"/tongdaoPlatform/weixin/donghang/",
		...
		ppStopImagePath:window.location.protocol+"//"+window.location.host+"/tongdaoPlatform/weixin/donghang/images/",
		dh:"http://cxrs.ceair.com/",
};
/**
