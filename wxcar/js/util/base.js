...
var base = {
		//url:"http://10.11.37.178:8080/tongdaoPlatform/",
		//url:"http://td-uat.ta-by.com/tongdaoPlatform/",
		url : window.location.protocol+"//"+window.location.host+"/tongdaoPlatform/",
		urlsxy : window.location.protocol+"//"+window.location.host+"/tongdaoSxyPlatform/",//随心意地址
...
$.ajaxPrevent = function() {
	...
	ajaxPrevent += "<div class='ajax_prevent_a' style='width: 30%;margin-top: 55%;"
			...
			+ "color: #585858;'>";
	ajaxPrevent += "<img src='../../images/dh_loading.gif' style='width:100%'></div></div>";
