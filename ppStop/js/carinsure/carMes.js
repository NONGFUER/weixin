...
$(function() {
	...
	issueChannel=getUrlQueryString("issueChannel");
	if(userName!=null){
		...
		issueChannel=parm.body.inforCar.issueChannel;
	}
	/**首页banner跳转***/
	$(".banner").attr("href",base.url1+"html/carinsure/carInfo.html"+window.location.search);
