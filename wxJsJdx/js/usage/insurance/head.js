...
if(getUrlQueryString("jsonKey")){
	...
	urlParm.provinceCode = getUrlQueryString("provinceCode") ? getUrlQueryString("provinceCode") :"";
	urlParm.cityCode = getUrlQueryString("cityCode") ? getUrlQueryString("cityCode") :"";
